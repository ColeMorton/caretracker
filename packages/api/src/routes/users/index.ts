import type {
  ...
  PaginatedResponse,
  ApiUser,
} from '@caretracker/shared'
import { type FastifyPluginAsync } from 'fastify'

const users: FastifyPluginAsync = async (fastify, _opts) => {
  fastify.get<{
    readonly Querystring: { readonly page?: number; readonly limit?: number }
    readonly Reply: PaginatedResponse<ApiUser>
  }>(
    '/',
    {
      schema: {
  ...
  fastify.get<{
    ...
    readonly Reply: ApiResponse<ApiUser>
  }>(
    '/:id',
    {
      schema: {
